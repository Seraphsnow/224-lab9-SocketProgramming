...
int main(int argc, char *argv[])
{
    if (argc != 4)
    {
        cerr << "Run the code with 3 command line arguments, first is serverIPAddr:port and second is the file to recieve and third is the recieve interva.\n";
        exit(1);
    }

    string ipport = argv[1], filename = argv[2];
    int revInt = stoi(argv[3]);
    int portnum;
